...
const signinController = async(req, res) => {
    ...
    //oauth
    axios.get('https://www.gogoleapis.com/oauth2/v3/userinfo', {
            headers:{
...
const signupController = async(req, res) =>{
    if(req.body.googleAccessToken){
        ...
        axios.get('https://www.gogoleapis.com/oauth2/v3/userinfo', {
            ...
            res.status(200).json({result_token})
        }).catch(err=>{
        ...
        try{
            ...
            const result = await User.create(password: hashPassword,firstName, lastName, email)
